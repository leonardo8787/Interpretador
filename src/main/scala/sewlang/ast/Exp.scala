...
case class SubExp(exp1: Exp, exp2: Exp) extends Exp // (- exp1 exp2)
...
case class LessOrEqualThanExp(exp1: Exp, exp2: Exp) extends Exp // (<= exp1 exp2)
case class LargerThanExp(exp1: Exp, exp2: Exp) extends Exp // (> exp1 exp2)
case class LargerOrEqualThanExp(exp1: Exp, exp2: Exp) extends Exp // (>= exp1 exp2)
